...
system_tools="htop fd ncdu unrar p7zip file-roller openblas blas-openblas poppler-data man-db man-pages eza bat ripgrep gnome-keyring fastfetch borg python-llfuse polkit-gnome systembus-notify neovim duf dog trash-cli"
