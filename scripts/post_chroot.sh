...
sway="sway xorg-xwayland swaybg swayidle swaylock xdg-desktop-portal xdg-desktop-portal-wlr waybar python-requests rofi-wayland dunst papirus-icon-theme wl-clipboard wf-recorder grim slurp satty acpi jq"
